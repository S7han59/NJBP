...
proxies:
  - {"name":"2023年10月5日_1","type":"trojan","server":"18.169.70.57","port":22222,"udp":true,"password":"telegram-id-privatevpns","sni":"trj.rollingnext.co.uk","skip-cert-verify":true,"network":"tcp"}
  - {"name":"2023年10月5日_2","type":"ss","server":"35.72.2.46","port":443,"password":"amazonskr05","cipher":"aes-256-cfb"}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
