...
proxies:
  ...
  - name: South Korea 06 @nodpai
    ...
    udp: true
  - name: V1C | 动态 01
    server: kr-cdn-6273819.starnetcn.top
    port: 53782
    type: vmess
    uuid: 8e73f50a-35cd-4235-9c18-a3e061e7bc9f
    alterId: 0
    cipher: auto
    tls: false
    skip-cert-verify: true
    network: ws
    ws-path: /1c1791euidqihd
    ws-headers:
      Host: 127.0.0.1
    udp: true
  - name: V1C | 德国 01
    ...
    skip-cert-verify: true
    network: ws
    ws-path: /315d825893fc34aca0231ab967157986
    ws-headers:
