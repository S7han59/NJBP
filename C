# 生成地址：v2rayse.com
# 模版名称：ACL4SSR_WithChinaIp_WithGFW.ini
# 生成时间：2024-10-15 14:17:35
# 不要随意改变关键字，否则会导致出错
# acl4SSR规则
# 去广告：支持
# 自动测速：支持
...
proxies:
  ...
  - name: 2024年10月15日_快线_2
    ...
    password: amazonskr05
    cipher: aes-256-cfb
  - name: 2024年10月15日_快线_3
    port: 443
    server: 13.212.100.34
    type: ss
    udp: true
    password: amazonskr05
    cipher: aes-256-cfb
  - name: 2024年10月15日_快线_4
    port: 443
    server: 52.43.33.6
    type: ss
    udp: true
